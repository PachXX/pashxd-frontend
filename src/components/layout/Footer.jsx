        ...
        <div className="grid grid-cols-2 md:grid-cols-12 gap-8 md:gap-12">
          <div className="col-span-2 md:col-span-4">
            ...
            <div className="flex gap-3 md:gap-4 mt-6 md:mt-8">
              ...
              <a href="https://www.instagram.com/pashx.ai" target="_blank" rel="noopener noreferrer" className="w-9 h-9 md:w-10 md:h-10 rounded-full border border-slate-200 flex items-center justify-center text-slate-400 hover:text-green-600 hover:border-green-200 transition" aria-label="Instagram">
                <FaInstagram size={15} />
              </a>
              <a href="mailto:info@pashx.com" className="w-9 h-9 md:w-10 md:h-10 rounded-full border border-slate-200 flex items-center justify-center text-slate-400 hover:text-green-600 hover:border-green-200 transition" aria-label="Email">
                <Mail size={15} />
              </a>
            </div>
          </div>
          ...
          <div className="md:col-span-2">
            <h4 className="text-xs tracking-[0.2em] text-green-600 font-semibold mb-4 md:mb-6">PRODUCT</h4>
          ...
          <div className="md:col-span-2">
            <h4 className="text-xs tracking-[0.2em] text-green-600 font-semibold mb-4 md:mb-6">COMPANY</h4>
            <ul className="space-y-3 md:space-y-4 text-sm text-slate-600">
          ...
          <div className="col-span-2 md:col-span-2">
            <h4 className="text-xs tracking-[0.2em] text-green-600 font-semibold mb-4 md:mb-6">CONTACT</h4>
            <ul className="space-y-3 md:space-y-4 text-sm text-slate-600">
              <li><a href="mailto:info@pashx.com" className="hover:text-green-600 transition">info@pashx.com</a></li>
              <li><a href="mailto:shahil@pashx.com" className="hover:text-green-600 transition">shahil@pashx.com</a></li>
              <li><a href="tel:+491577802062" className="hover:text-green-600 transition">+49 157 7802062</a></li>
            </ul>
          </div>
        </div>
